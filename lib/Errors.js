...
var Errors = /*#__PURE__*/function (_Error) {
  ...
  _createClass(Errors, null, [{
    ...
    get: function get() {
      return Object.freeze({
        ...
        noTemplateWithName: function noTemplateWithName(templateName) {
          return new Error("ApiMailAdapter: No template found with name '".concat(templateName, "'."));
        }
      });
    }
  }]);
